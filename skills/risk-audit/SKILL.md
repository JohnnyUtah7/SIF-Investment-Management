...
<!-- Provenance: analyst-kit research-auditor agent; equity-research-skill kill criteria;
     strengthened after King'sHand IREN audit 2026-09-20 -->
...
- **FAIL or required-fix** if any of these IREN-class gates trip:
...
IREN-class audits failed when this table was absent — do not skip.
